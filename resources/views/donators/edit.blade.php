...
<div class="d-flex align-items-center mb-4">
    <a href="{{ route('donators.index') }}" class="btn btn-outline-secondary me-3 rounded-circle"
        style="width:40px;height:40px;display:flex;align-items:center;justify-content:center;">
        <i class="fa-solid fa-arrow-left"></i>
    </a>
    <div>
        <h2 class="fw-bold mb-0">Edit Donator</h2>
...
<div class="row justify-content-center">
    <div class="col-lg-8">
        ...
        <form action="{{ route('donators.update', $donator->id) }}" method="POST">
            @csrf
            @method('PUT')
                ...
                <div class="card-body p-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="full_name" class="form-control"
                            value="{{ old('full_name', $donator->full_name) }}" required>
                    </div>

                    <div class="mb-3">
                        <label class="form-label fw-bold">Contact Number</label>
                        <input type="text" name="contact_number" class="form-control"
                            value="{{ old('contact_number', $donator->contact_number) }}" required>
                    </div>
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        <a href="{{ route('donators.index') }}" class="btn btn-light border">
                            {{ __('messages.cancel') }}
                        </a>
