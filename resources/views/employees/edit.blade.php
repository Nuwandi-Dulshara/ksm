...
<div class="d-flex align-items-center mb-4">
    ...
    <div>
        <h2 class="fw-bold text-dark mb-0">Edit Employee</h2>
        <p class="text-muted mb-0">Update profile, salary, and payment details.</p>
    </div>
</div>
                ...
                <div class="card-body p-4">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea name="bank_details" class="form-control" rows="2"
                                placeholder="e.g. FIB Bank, Account: 1234-5678...">{{ old('bank_details', $employee->bank_details) }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        <a href="{{ asset('storage/' . $employee->document_path) }}" target="_blank"
                            ...
                            <i class="fa-solid fa-file-lines me-2"></i> View Current Document
                        </a>
                    </div>
                    @endif
