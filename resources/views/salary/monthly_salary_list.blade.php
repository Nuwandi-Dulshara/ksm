        ...
        <table class="table-salary">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-end">{{ $row['deduction'] > 0 ? 'IQ ' . number_format($row['deduction'], 2) : '-' }}</td>
            ...
            <tfoot>
                <tr class="total-row">
                    ...
                    <td class="text-end">{{ $totals['bonus'] > 0 ? 'IQ ' . number_format($totals['bonus'], 2) : '-' }}</td>
                    <td class="text-end">{{ $totals['deduction'] > 0 ? 'IQ ' . number_format($totals['deduction'], 2) : '-' }}</td>
