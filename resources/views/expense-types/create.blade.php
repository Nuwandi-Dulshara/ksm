...
<div class="container-fluid px-4 py-4">
    ...
    <div class="d-flex align-items-center mb-4">
        ...
        <div>
            <h2 class="fw-bold text-dark mb-0">{{ __('messages.add_expense_type') }}</h2>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="row g-3">
                            <div class="col-md-12">
                                ...
                                <input type="text" name="expense_type" class="form-control"
                                    placeholder="{{ __('messages.enter_expense_type') }}" required>
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-end gap-2 mt-4">
                            ...
                            <button type="submit" class="btn btn-primary fw-bold px-4">
                                <i class="fa-solid fa-save me-2"></i> Save Expense Type
                            </button>
                        </div>
