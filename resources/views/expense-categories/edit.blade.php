...
<div class="container-fluid px-4 py-4">
    ...
    <div class="d-flex align-items-center mb-4">
        <a href="{{ route('expense-categories.index') }}" class="btn btn-outline-secondary me-3 rounded-circle"
                ...
                <div class="card shadow-sm border-0">
                    <div class="card-body p-4">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-12">
                                <label class="form-label fw-bold">{{ __('messages.expense_categories') }}</label>
                                <input type="text" name="category_name" value="{{ $expenseCategory->category_name }}"
                        ...
                        <div class="d-flex justify-content-end gap-2 mt-4">
                            <a href="{{ route('expense-categories.index') }}" class="btn btn-light border">
                                {{ __('messages.cancel') }}
                            </a>
